...
class GPT2ArthmDecoder:
    ...
    def __init__(self, l=4, r=8, code=None, seed="I think", toker=None, model=None, rotater_len = 0, time_data_dump = None):
        self.r = r
        self.l = l
        ...
        self.C_cursor = l
        self.c_padding = 1
        self.M = gpt2modellib.GPT2Model(first_phrase=seed, toker=toker, model=model, rotater_len=rotater_len, time_data_dump=time_data_dump)
        self.seed = seed
        if code is None:
            exit(1)
